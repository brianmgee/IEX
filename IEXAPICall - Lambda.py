...
writer = pd.ExcelWriter('/tmp/stock_market_data.xlsx', engine='xlsxwriter')
...
# s3.meta.client.upload_file('stock_market_data.xlsx', 'konidra-usw1-iex', '/tmp/stock_market_data.xlsx', ExtraArgs={'ACL':'public-read'})
# End of my IEX Python code

def lambda_handler(event, context):
    # TODO implement
    string = "test"

    file_name = "stock_market_data.xlsx"
    ...
    s3 = boto3.resource('s3')
    s3.meta.client.upload_file(lambda_path, 'konidra-usw1-iex', s3_path)

    return {
        'statusCode': 200,
        'body': json.dumps('File was created in: '+s3_path)
    }